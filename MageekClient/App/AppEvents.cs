...
namespace MaGeek
{
    ...
    public class AppEvents
    {
        ...
        // Deck Selected
        public virtual void RaiseDeckSelect(int deckId) { SelectDeckEvent?.Invoke(deckId); }
        public delegate void SelectDeckHandler(int deckId);
    ...
    public class ChangeCardRelationVariantCommand : ICommand
    {
        ...
        public async void Execute(object parameter)
        {
            ...
            await Mageek.SwitchCardInDeck(relation, variant);
        }
