...
namespace MageekFrontWpf.ViewModels
{
    public class TopMenuViewModel
    {
        ...
        {
            winManager.OpenWindow(Windows.txtImporter);
        }

        private void OpenWindow_PrecoImporter()
        {
            winManager.OpenWindow(Windows.precoImporter);
        }

        private void OpenWindow_ProxyPrint()
        {
            winManager.OpenWindow(Windows.proxyPrint);
        }

        private void OpenWindow_CollectionEstimation()
        {
            winManager.OpenWindow(Windows.collectionEstimation);
        }
        ...
        {
            config.SetSetting(Settings.ForeignLanguage, newLang);
        ...
        {
            config.SetSetting(Settings.Currency, newCurrency);
