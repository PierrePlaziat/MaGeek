...
namespace MaGeek.UI.Menus
{
    ...
    public partial class TopMenu : TemplatedUserControl
    {
        ...
        {
            InitializeComponent();
            UpdateLangIcons(App.Config.Settings[UserSetting.ForeignLanguage]);
            UpdateCurrencyIcons(App.Config.Settings[UserSetting.Currency]);
        }
        ...
        private void ChangeLanguage(object sender, RoutedEventArgs e)
        {
            ...
            App.Config.SetSetting(UserSetting.ForeignLanguage, item.Header.ToString());
        ...
        private void ChangeCurrency(object sender, RoutedEventArgs e)
        {
            ...
            App.Config.SetSetting(UserSetting.Currency, s.Header.ToString());
